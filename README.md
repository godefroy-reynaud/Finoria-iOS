...
All five persisted types are SwiftData `@Model` classes. For CloudKit compatibility, every property has a default value, none is marked unique, and to-one relationships are optional on the child side.
